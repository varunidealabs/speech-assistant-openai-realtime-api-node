...
if (!AZURE_OPENAI_API_KEY) {
    console.error('Missing Azure OpenAI API key. Please set it in the .env file.');
    process.exit(1);
}
...
fastify.register(async (fastify) => {
    fastify.get('/media-stream', { websocket: true }, (connection, req) => {
        ...
        const openAiWs = new WebSocket('wss://access-01.openai.azure.com/openai/realtime?api-version=2024-10-01-preview&deployment=gpt-4o-realtime-preview', {
            headers: {
